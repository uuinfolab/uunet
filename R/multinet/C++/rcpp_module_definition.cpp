...
void show_multilayer_network(RMLNetwork *mnet)
{
...
RCPP_MODULE(multinet)
{
    ...
    function("nodes.ml",
             &nodes,
             List::create( _["mlnetwork"], _["layers"]=CharacterVector()),
             "Returns the list of nodes in the input layers, or in the whole multilayer network if no layers are specified");
    function("edges.ml",
             &edges,
             List::create( _["mlnetwork"], _["layers1"]=CharacterVector(), _["layers2"]=CharacterVector()),
             "Returns the list of edges among nodes in the input layers (if only one set of layers is specified), or from the first set of input layers to the second set of input layers, or in the whole multilayer network if no layers are specified");

    function("edges.idx.ml",
             &edges_idx,
             List::create( _["mlnetwork"]),
             "Returns the list of edges, where node ids are used instead of node names");
    ...
    function("num.nodes.ml",
             &numNodes,
             List::create( _["mlnetwork"], _["layers"]=CharacterVector()),
             "Returns the number of nodes in the set of input layers, or in the whole mlnetwork if no layers are specified");
