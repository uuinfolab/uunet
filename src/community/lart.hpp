...
class lart
{
  ...
  public:
    ...
    */
    CommunityStructureSharedPtr
    fit(MLNetworkSharedPtr mnet, int t, double eps, double gamma);
  ...
  private:
    ...
    */
    ...
    int
    is_connected(std::vector<Eigen::SparseMatrix<double>> a, std::vector<dlib::sample_pair>& edges);
    ...
    */
    ...
    diagA(Eigen::SparseMatrix<double> m);
    ...
    */
    unsigned long
    prcheck(Eigen::SparseMatrix<double>& aP, std::vector<dlib::sample_pair> edges, unsigned int LN);
    ...
    */
    void
    exp_by_squaring_iterative(Eigen::SparseMatrix<double>& x, int t);
    ...
    */
    Eigen::MatrixXd
    Dmat(Eigen::SparseMatrix<double> Pt, Eigen::SparseMatrix<double> D, size_t L);
    ...
    */
    Eigen::MatrixXd
    pairwise_distance(Eigen::MatrixXd X, Eigen::MatrixXd Y, bool same_obj);
    ...
    */
    ...
    find_ix(std::vector<unsigned long> x, unsigned long y);
    ...
    */
    void
    updateDt(Eigen::MatrixXd& Dt, std::vector<Eigen::SparseMatrix<double>> a);
    ...
    */
    vector<double>
    modMLPX(vector<dlib::bu_cluster> clusters, std::vector<Eigen::SparseMatrix<double>> a, double gamma);
