#ifndef UU_OLAP_MECUBE_H_
#define UU_OLAP_MECUBE_H_
...
/**
 * An Edge Cube (MECube) allows us to store edges between two VCubes (or, as a special case,
 * between a VCube and itself).
 * As a VCube, an MECube provides the functionality of a set of edges, allows edges attributes,
    ...
    MECube
{
  ...
  protected:
     ...
     * is also updated.
     */
    core::UnionObserver<MDMultiEdgeStore, const MLEdge2>*
    register_obs(
    );
