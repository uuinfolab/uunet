...
{
    static size_t
    write(std::string value, std::FILE* file)
    {
    ...
    static size_t
    read(std::string& value, ifstream& ifstream)
    {
...
class SafeBinaryOutFile
{
  ...
  private:
    ...
    SafeBinaryOutFile &
    operator= (const SafeBinaryOutFile &);
};
...
inline
bool
isDirectoryWritable(const std::string& dir)
{
