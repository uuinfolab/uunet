...
)
{
    ...
    if (sidx_neighbors_out.count(e->v1)==0)
    {
        ...
        sidx_incident_out[e->v1] = std::make_unique<EdgeList>();
    }
    ...
    if (sidx_neighbors_in.count(e->v2)==0)
    {
        ...
        sidx_incident_in[e->v2] = std::make_unique<EdgeList>();
    }
    ...
    if (sidx_neighbors_all.count(e->v1)==0)
    {
        ...
        sidx_incident_all[e->v1] = std::make_unique<EdgeList>();
    }
    ...
    if (sidx_neighbors_all.count(e->v2)==0)
    {
        ...
        sidx_incident_all[e->v2] = std::make_unique<EdgeList>();
    }
