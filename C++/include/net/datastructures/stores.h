/**
 * This module defines the main containers used by graphs to store their
 * objects (vertices, edges, etc.).
 *
 * The classes defined in this module are defined based on those in the
 * template module.
 *
 * History:
...
#ifndef UU_NET_DATASTRUCTURES_STORES_H_
#define UU_NET_DATASTRUCTURES_STORES_H_
