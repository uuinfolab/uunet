...
#ifndef UU_NET_MEASURES_COMPONENTS_H_
#define UU_NET_MEASURES_COMPONENTS_H_
...
{
    assert_not_null(g, "components", "g");
    ...
    for (auto v: *g->vertices())
    {
        ...
        else
        {
            ...
            {
                size_t pos_current_vertex = g->vertices()->get_index(current_vertex);
