...
/**
 * An AttributeStore implemented as main memory maps.
 */
template <typename ID>
class MainMemoryAttributeStore :
    public AttributeStore<ID>
{
  private:
    typedef AttributeStore<ID> super;
...
template <typename ID>
bool
MainMemoryAttributeStore<ID>::add_index (
    const std::string& attribute_name
)
{
...
template <typename ID>
void
MainMemoryAttributeStore<ID>::set_double (
    ID oid,
    const std::string& attribute_name,
    double val
)
...
template <typename ID>
void
MainMemoryAttributeStore<ID>::set_int (
    ID oid,
    const std::string& attribute_name,
    int val
)
...
template <typename ID>
void
MainMemoryAttributeStore<ID>::set_string (
    ID oid,
    const std::string& attribute_name,
...
template <typename ID>
void
MainMemoryAttributeStore<ID>::set_time (
    ID oid,
    const std::string& attribute_name,
    const Time& val
)
...
template <typename ID>
void
MainMemoryAttributeStore<ID>::set_text (
    ID oid,
    const std::string& attribute_name,
    const Text& val
)
...
template <typename ID>
Value<double>
MainMemoryAttributeStore<ID>::get_double (
    ID oid,
    const std::string& attribute_name
) const
{
...
template <typename ID>
Value<int>
MainMemoryAttributeStore<ID>::get_int (
    ID oid,
    const std::string& attribute_name
) const
{
...
template <typename ID>
Value<std::string>
MainMemoryAttributeStore<ID>::get_string (
    ID oid,
    const std::string& attribute_name
) const
{
...
template <typename ID>
Value<Time>
MainMemoryAttributeStore<ID>::get_time (
    ID oid,
    const std::string& attribute_name
) const
{
...
template <typename ID>
Value<Text>
MainMemoryAttributeStore<ID>::get_text(
    ID oid,
    const std::string& attribute_name
) const
{
...
template <typename ID>
Value<double>
MainMemoryAttributeStore<ID>::get_min_double (
    const std::string& attribute_name
) const
{
    auto attr = double_attribute.find(attribute_name);
...
template <typename ID>
Value<double>
MainMemoryAttributeStore<ID>::get_max_double (
    const std::string& attribute_name
) const
{
    auto attr = double_attribute.find(attribute_name);
...
template <typename ID>
Value<int>
MainMemoryAttributeStore<ID>::get_min_int (
    const std::string& attribute_name
) const
{
    auto attr = int_attribute.find(attribute_name);
...
template <typename ID>
Value<int>
MainMemoryAttributeStore<ID>::get_max_int (
    const std::string& attribute_name
) const
{
    auto attr = int_attribute.find(attribute_name);
...
template <typename ID>
Value<std::string>
MainMemoryAttributeStore<ID>::get_min_string (
    const std::string& attribute_name
) const
{
    auto attr = string_attribute.find(attribute_name);
...
template <typename ID>
Value<std::string>
MainMemoryAttributeStore<ID>::get_max_string (
    const std::string& attribute_name
) const
{
    auto attr = string_attribute.find(attribute_name);
...
template <typename ID>
Value<Time>
MainMemoryAttributeStore<ID>::get_min_time (
    const std::string& attribute_name
) const
{
    auto attr = time_attribute.find(attribute_name);
...
template <typename ID>
Value<Time>
MainMemoryAttributeStore<ID>::get_max_time (
    const std::string& attribute_name
) const
{
    auto attr = time_attribute.find(attribute_name);
...
template <typename ID>
std::vector<ID>
MainMemoryAttributeStore<ID>::range_query_string (
    const std::string& attribute_name,
    const std::string& min_value,
    const std::string& max_value
) const
...
template <typename ID>
std::vector<ID>
MainMemoryAttributeStore<ID>::range_query_int (
    const std::string& attribute_name,
    const int& min_value,
    const int& max_value
) const
...
template <typename ID>
std::vector<ID>
MainMemoryAttributeStore<ID>::range_query_double (
    const std::string& attribute_name,
    const double& min_value,
    const double& max_value
) const
...
template <typename ID>
std::vector<ID>
MainMemoryAttributeStore<ID>::range_query_time (
    const std::string& attribute_name,
    const Time& min_value,
    const Time& max_value
) const
...
template <typename ID>
bool
MainMemoryAttributeStore<ID>::reset (
    ID id,
    const std::string& attribute_name
)
{
