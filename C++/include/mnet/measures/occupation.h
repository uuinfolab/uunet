...
template <typename M>
hash_map<ActorSharedPtr, int> occupation(
...
/**********************************************************************/
    ...
    template <typename M>
double cc(const M* mnet, const NodeSharedPtr& node);
...
property_matrix<ActorSharedPtr,LayerSharedPtr,bool> actor_existence_property_matrix(const M* mnet);
property_matrix<dyad,LayerSharedPtr,bool> edge_existence_property_matrix(const M* mnet);
property_matrix<triad,LayerSharedPtr,bool> triangle_existence_property_matrix(const M* mnet);
    property_matrix<ActorSharedPtr,LayerSharedPtr,double> actor_degree_property_matrix(const M* mnet, EdgeMode mode);
    property_matrix<ActorSharedPtr,LayerSharedPtr,double> actor_cc_property_matrix(const M* mnet);
...
/**********************************************************************/
    ...
    template <typename M>
hash_map<ActorSharedPtr,std::set<path_length> > pareto_distance(const M* mnet, const Vertex* from);
/*
