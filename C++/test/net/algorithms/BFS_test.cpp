...
TEST_F(net_algorithms_BFS_test, undirected)
{
    ...
    uu::net::BFS<uu::net::SimpleGraph> bfs(g.get(), v0, uu::net::EdgeMode::INOUT);
...
{
    auto v0 = g->vertices()->get("v0");
    uu::net::BFS<uu::net::SimpleGraph> bfs(g.get(), v0, uu::net::EdgeMode::OUT);
...
TEST_F(net_algorithms_BFS_test, directed_out2)
{
    ...
    uu::net::BFS<uu::net::SimpleGraph> bfs(g.get(), v5, uu::net::EdgeMode::OUT);
...
{
    auto v5 = g->vertices()->get("v5");
    uu::net::BFS<uu::net::SimpleGraph> bfs(g.get(), v5, uu::net::EdgeMode::IN);
...
{
    auto v0 = g->vertices()->get("v0");
    uu::net::BFS<uu::net::SimpleGraph> bfs(g.get(), v0, uu::net::EdgeMode::IN);
