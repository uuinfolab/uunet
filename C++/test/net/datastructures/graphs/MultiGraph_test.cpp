...
class net_datastructures_graphs_MultiGraph_test : public ::testing::Test
{
  protected:
    virtual void
    SetUp()
...
TEST_F(net_datastructures_graphs_MultiGraph_test, all_functions)
{

    auto g = uu::net::create_multi_graph("a graph", uu::net::EdgeDir::DIRECTED);
