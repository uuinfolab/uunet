...
class net_datastructures_graphs_AttributedSimpleGraph_test : public ::testing::Test
{
  protected:
    virtual void
    SetUp()
...
TEST_F(net_datastructures_graphs_AttributedSimpleGraph_test, all_functions)
{

    std::unique_ptr<uu::net::AttributedSimpleGraph> g = uu::net::create_attributed_simple_graph("a graph", uu::net::EdgeDir::DIRECTED);
