...
#include "net/datastructures/stores.h"
...
TEST_F(StoreTest, VertexStore) {
    std::unique_ptr<uu::net::VertexStore> vs;
    vs = uu::net::create_vertex_store();
    ...
    // Checking if a vertex belong to this store
...
TEST_F(StoreTest, DirectedSimpleEdgeStore) {
    using A = uu::net::EmptyAttributeStore<uu::net::Edge>;
    using E = uu::net::DirectedSimpleEdgeStore<A>;
