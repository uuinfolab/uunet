...
class net_io_probabilistic_graph_test : public ::testing::Test
{
  protected:
    ...
    SetUp() override
    {
        ...
        test_file << "v1,v2,0.45         " << std::endl;
        test_file << "v1,v3,0.553        " << std::endl;
        test_file << "v2,v1,0.35         " << std::endl;
        test_file << "v1,v4,0.519        " << std::endl;
        test_file.close();
    }
...
TEST_F(net_io_probabilistic_graph_test, read)
{
    auto g = uu::net::read_probabilistic_graph(test_file_name, "g", ',');                         
