...
TEST(core_datastructures_containers_SortedRandomSet_test, integer_key)
{
    ...
    EXPECT_EQ(1, set.get_at_index(set.get_index(1)))
            << "get_index and get_at_index not aligned";
    EXPECT_EQ(2, set.get_at_index(set.get_index(2)))
            << "get_index and get_at_index not aligned";
    EXPECT_EQ(3, set.get_at_index(set.get_index(3)))
            << "get_index and get_at_index not aligned";
...
TEST(core_datastructures_containers_SortedRandomSet_test, raw_pointer_key)
{
