...
class net_io_read_attributed_multiplex_test : public ::testing::Test
{
  protected:
...
TEST_F(net_io_read_attributed_multiplex_test, read)
{
    auto net = uu::net::read_attributed_multiplex(test_file_name, "g", ',');
