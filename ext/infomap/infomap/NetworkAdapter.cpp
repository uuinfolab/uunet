...
bool
NetworkAdapter::readExternalHierarchy(std::string filename)
{
    bool ok = true;
...
void
NetworkAdapter::readClu(std::string filename)
{
...
void
NetworkAdapter::readHumanReadableTree(std::string filename)
{
    std::string line;
    std::string buf;
