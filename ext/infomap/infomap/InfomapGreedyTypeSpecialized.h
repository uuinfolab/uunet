...
class InfomapGreedyTypeSpecialized : public InfomapGreedyCommon<InfomapGreedyTypeSpecialized<FlowType, NetworkType> >
{
  ...
  protected:
    ...
    void
    calculateNodeFlow_log_nodeFlowForMemoryNetwork() {}
...
class InfomapGreedyTypeSpecialized<FlowType, WithMemory> : public InfomapGreedyCommon<InfomapGreedyTypeSpecialized<FlowType, WithMemory> >
{
    ...
    struct IndexedFlow
    {
        ...
        IndexedFlow&
        operator=(const IndexedFlow& other)
        {
            index = other.index;
  ...
  protected:
    ...
    virtual bool
    preClusterMultiplexNetwork(bool printResults = false);

    virtual unsigned int
    aggregateFlowValuesFromLeafToRoot();

    virtual double
    calcCodelengthOnRootOfLeafNodes(const NodeBase& parent);
    virtual double
    calcCodelengthOnModuleOfModules(const NodeBase& parent);
    virtual double
    calcCodelengthOnModuleOfLeafNodes(const NodeBase& parent);
    ...
    virtual void
    saveHierarchicalNetwork(HierarchicalNetwork& output, std::string rootName, bool includeLinks);

    virtual void
    printClusterNumbers(std::ostream& out);

    virtual void
    printFlowNetwork(std::ostream& out);
  ...
  private:
    NodeType&
    getNode(NodeBase& node)
    {
        return static_cast<NodeType&>(node);
    }
    const NodeType&
    getNode(const NodeBase& node) const
    {
...
template<typename FlowType>
inline bool
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::preClusterMultiplexNetwork(bool printResults)
{
...
template<typename FlowType>
inline unsigned int
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::aggregateFlowValuesFromLeafToRoot()
{
...
template<typename FlowType>
inline double
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::calcCodelengthOnRootOfLeafNodes(const NodeBase& parent)
{
...
template<typename FlowType>
inline double
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::calcCodelengthOnModuleOfLeafNodes(const NodeBase& parent)
{
    // return Super::calcCodelengthOnModuleOfLeafNodes(parent);
...
template<typename FlowType>
inline double
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::calcCodelengthOnModuleOfModules(const NodeBase& parent)
{
...
template<typename FlowType, typename NetworkType>
void
InfomapGreedyTypeSpecialized<FlowType, NetworkType>::initModuleOptimization()
{
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::initModuleOptimization()
{
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::calculateNodeFlow_log_nodeFlowForMemoryNetwork()
{
...
inline
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::addContributionOfMovingMemoryNodes(NodeType& current,
        DeltaFlowType& oldModuleDelta, std::vector<DeltaFlowType>& moduleDeltaEnterExit,
        std::vector<unsigned int>& redirect, unsigned int& offset, unsigned int& numModuleLinks)
{
    // Overlapping modules
...
inline
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::performMoveOfMemoryNode(NodeType& current,
...
inline
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::performPredefinedMoveOfMemoryNode(NodeType& current,
...
template<typename FlowType>
double
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::getDeltaCodelengthOnMovingMemoryNode(DeltaFlowType& oldModuleDelta, DeltaFlowType& newModuleDelta)
{
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::updateCodelengthOnMovingMemoryNode(DeltaFlowType& oldModuleDelta, DeltaFlowType& newModuleDelta)
{
    double delta_nodeFlow_log_nodeFlow = oldModuleDelta.sumDeltaPlogpPhysFlow + newModuleDelta.sumDeltaPlogpPhysFlow + oldModuleDelta.sumPlogpPhysFlow - newModuleDelta.sumPlogpPhysFlow;
...
template<typename FlowType, typename NetworkType>
void
InfomapGreedyTypeSpecialized<FlowType, NetworkType>::generateNetworkFromChildren(NodeBase& parent)
{
    // Clone all nodes
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::consolidatePhysicalNodes(std::vector<NodeBase*>& modules)
{
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::generateNetworkFromChildren(NodeBase& parent)
{
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::saveHierarchicalNetwork(HierarchicalNetwork& output, std::string rootName, bool includeLinks)
{
...
template<typename FlowType>
void
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::printFlowNetwork(std::ostream& out)
{
    unsigned int indexOffset = m_config.zeroBasedNodeNumbers ? 0 : 1;
...
inline
std::vector<PhysData>&
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::getPhysicalMembers(NodeBase& node)
{
...
inline
StateNode&
InfomapGreedyTypeSpecialized<FlowType, WithMemory>::getMemoryNode(NodeBase& node)
{
