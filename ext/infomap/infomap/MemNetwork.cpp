...
void
MemNetwork::readInputData(std::string filename)
{
    if (filename.empty())
    {
...
std::string
MemNetwork::parseStateNodes(std::ifstream& file)
{
    std::string line;
...
std::string
MemNetwork::parseStateLinks(std::ifstream& file)
{
...
void
MemNetwork::simulateMemoryToIncompleteData()
{
...
void
MemNetwork::parseStateNode(const std::string& line, StateNode& stateNode)
{
    m_extractor.clear();
...
void
MemNetwork::parseStateLink(const std::string& line, int& n1, unsigned int& n2, unsigned int& n3, double& weight)
{
    m_extractor.clear();
    m_extractor.str(line);
...
void
MemNetwork::parseStateLink(char line[], int& n1, unsigned int& n2, unsigned int& n3, double& weight)
{
    char *cptr;
...
void
MemNetwork::addStateNode(StateNode& stateNode)
{
...
bool
MemNetwork::addStateLink(unsigned int n1PriorState, unsigned int n1, unsigned int n2PriorState, unsigned int n2, double weight, double firstStateNodeWeight, double secondStateNodeWeight)
{
...
bool
MemNetwork::addStateLink(StateLinkMap::iterator firstStateNode, unsigned int n2PriorState, unsigned int n2, double weight, double firstStateNodeWeight, double secondStateNodeWeight)
{
    ++m_numStateLinksFound;
...
bool
MemNetwork::addStateLink(const StateNode& s1, const StateNode& s2, double weight)
{
    ++m_numStateLinksFound;
...
bool
MemNetwork::insertStateLink(unsigned int n1PriorState, unsigned int n1, unsigned int n2PriorState, unsigned int n2, double weight)
{
...
bool
MemNetwork::insertStateLink(const StateNode& s1, const StateNode& s2, double weight)
{
    ++m_numStateLinks;
...
bool
MemNetwork::insertStateLink(StateLinkMap::iterator firstStateNode, unsigned int n2PriorState, unsigned int n2, double weight)
{
    m_totStateLinkWeight += weight;
...
bool
MemNetwork::addIncompleteStateLink(unsigned int n1, unsigned int n2, double weight)
{
...
void
MemNetwork::finalizeAndCheckNetwork(bool printSummary)
{
...
unsigned int
MemNetwork::addMissingPhysicalNodes()
{
    std::vector<unsigned int> existingPhysicalNodes(m_numNodes);
...
void
MemNetwork::printParsingResult(bool includeFirstOrderData)
{
...
void
MemNetwork::printNetworkAsPajek(std::string filename) const
{
...
void
MemNetwork::printStateNetwork(std::string filename) const
{
    SafeOutFile out(filename.c_str());
