...
typedef double
ISEVALFN (struct isreport *rep, void *data);
typedef void
ISREPOFN (struct isreport *rep, void *data);
typedef void
ISRULEFN (struct isreport *rep, void *data,
...
----------------------------------------------------------------------*/
extern ISREPORT*
isr_create   (ITEMBASE *base);
extern ISREPORT*
isr_createx  (ITEMBASE *base, ITEM max);
extern int
isr_delete   (ISREPORT *rep, int delis);
extern ITEMBASE*
isr_base     (ISREPORT *rep);
extern ITEM
isr_size     (ISREPORT *rep);

extern int
isr_settarg  (ISREPORT *rep,
              int target, int mode, int dir);
extern int
isr_target   (ISREPORT *rep);
extern int
isr_mode     (ISREPORT *rep);
extern void
isr_setsupp  (ISREPORT *rep, RSUPP smin, RSUPP smax);
extern ITEM
isr_smin     (ISREPORT *rep);
extern ITEM
isr_smax     (ISREPORT *rep);
extern void
isr_setsize  (ISREPORT *rep, ITEM  zmin, ITEM  zmax);
extern ITEM
isr_zmin     (ISREPORT *rep);
extern ITEM
isr_zmax     (ISREPORT *rep);
extern ITEM
isr_xmax     (ISREPORT *rep);

extern RSUPP
isr_setbdr   (ISREPORT *rep, ITEM size, RSUPP supp);
extern RSUPP
isr_getbdr   (ISREPORT *rep, ITEM size);
extern void
isr_clrbdr   (ISREPORT *rep);
extern ITEM
isr_bdrcnt   (ISREPORT *rep);

extern int
isr_setfmt   (ISREPORT *rep, int scan, CCHAR *hdr,
              CCHAR *sep, CCHAR *imp, CCHAR *info);
extern int
isr_setfmtx  (ISREPORT *rep, int scan, CCHAR *hdr,
              CCHAR *sep, CCHAR *imp, CCHAR *info,
              CCHAR *iwf);
extern CCHAR*
isr_hdr      (ISREPORT *rep);
extern CCHAR*
isr_sep      (ISREPORT *rep);
extern CCHAR*
isr_imp      (ISREPORT *rep);
extern CCHAR*
isr_info     (ISREPORT *rep);
extern CCHAR*
isr_iwf      (ISREPORT *rep);

extern int
isr_setsmt   (ISREPORT *rep, RSUPP supp);
extern int
isr_setwgt   (ISREPORT *rep, double wgt);
extern void
isr_seteval  (ISREPORT *rep, ISEVALFN evalfn,
              void *data, int dir, double thresh);
extern void
isr_setrepo  (ISREPORT *rep, ISREPOFN repofn,
              void *data);
extern void
isr_setrule  (ISREPORT *rep, ISRULEFN rulefn,
              void *data);
extern int
isr_prefmt   (ISREPORT *rep, TID min, TID max);

extern int
isr_open     (ISREPORT *rep, FILE *file, CCHAR *name);
extern int
isr_close    (ISREPORT *rep);
extern FILE*
isr_file     (ISREPORT *rep);
extern CCHAR*
isr_name     (ISREPORT *rep);


extern void
isr_flush (ISREPORT *rep);
extern int
isr_tidopen  (ISREPORT *rep, FILE *file, CCHAR *name);
extern int
isr_tidclose (ISREPORT *rep);
extern void
isr_tidflush (ISREPORT *rep);
extern void
isr_tidcfg   (ISREPORT *rep, TID tracnt, ITEM miscnt);
extern FILE*
isr_tidfile  (ISREPORT *rep);
extern CCHAR*
isr_tidname  (ISREPORT *rep);
...
extern int
isr_addwgt   (ISREPORT *rep, ITEM item, RSUPP supp,
              double wgt);
extern int
...
extern int
isr_uses     (ISREPORT *rep, ITEM item);
extern void
isr_remove   (ISREPORT *rep, ITEM n);
extern int
isr_xable    (ISREPORT *rep, ITEM n);

extern ITEM
isr_cnt      (ISREPORT *rep);
extern ITEM
isr_item     (ISREPORT *rep);
extern ITEM
isr_itemx    (ISREPORT *rep, ITEM index);
extern const ITEM*
isr_items  (ISREPORT *rep);
extern RSUPP
isr_supp     (ISREPORT *rep);
extern RSUPP
isr_suppx    (ISREPORT *rep, ITEM index);
extern double
isr_wgt      (ISREPORT *rep);
extern double
isr_wgtx     (ISREPORT *rep, ITEM index);
extern double
isr_eval     (ISREPORT *rep);

extern ITEM
isr_pexcnt   (ISREPORT *rep);
extern ITEM
isr_pex      (ISREPORT *rep, ITEM index);
extern const int*
isr_pexs     (ISREPORT *rep);
extern ITEM
isr_all      (ISREPORT *rep);
extern ITEM
isr_lack     (ISREPORT *rep);
...
extern CCHAR*
isr_itemname (ISREPORT *rep, ITEM item);
extern void*
isr_itemobj  (ISREPORT *rep, ITEM item);
extern int
...
isr_seqrule  (ISREPORT *rep, const ITEM *items,ITEM n,
              ...
              double eval);
extern int
isr_sxrule   (ISREPORT *rep, const ITEM *ante, ITEM n,
...
extern size_t
isr_repcnt   (ISREPORT *rep);
extern const size_t*
isr_stats(ISREPORT *rep);
extern void
...
extern PATSPEC*
isr_getpsp   (ISREPORT *rep);
#endif
extern int
isr_intout   (ISREPORT *rep, diff_t num);
extern int
isr_numout   (ISREPORT *rep, double num, int digits);
extern int
isr_wgtout   (ISREPORT *rep, RSUPP supp, double wgt);
extern int
isr_sinfo    (ISREPORT *rep, RSUPP supp, double wgt,
              double eval);
extern int
isr_rinfo    (ISREPORT *rep, RSUPP supp,
              RSUPP body, RSUPP head, double eval);
extern int
isr_xinfo    (ISREPORT *rep, RSUPP supp,
              RSUPP body, RSUPP head,
              RSUPP salt, RSUPP halt, RSUPP join);
extern void
isr_getinfo  (ISREPORT *rep, const char *sel,
              double *vals);
#ifdef ISR_CLOMAX
extern ITEM*
isr_buf      (ISREPORT *rep);
extern int
isr_tail     (ISREPORT *rep, const ITEM *items,ITEM n);
#endif
