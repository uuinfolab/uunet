...
TEST(net_creation_test, null_graph)
{
    ...
    ASSERT_EQ(std::size_t(11), n->vertices()->size());
    ASSERT_EQ(std::size_t(0), n->edges()->size());
}
...
TEST(net_creation_test, null_multiplex)
{
    ...
    ASSERT_EQ(std::size_t(10), n->actors()->size());

    for (auto layer: *n->layers())
    {
        ASSERT_EQ(std::size_t(10), layer->vertices()->size());
        ASSERT_EQ(std::size_t(0), layer->edges()->size());
    }

    ASSERT_EQ(std::size_t(3), n->layers()->size());
}
...
TEST(net_creation_test, complete_graph)
{
    ...
    ASSERT_EQ(std::size_t(5), n->vertices()->size());
    ASSERT_EQ(std::size_t(10), n->edges()->size());
}
...
TEST(net_creation_test, complete_graph_directed)
{
    ...
    ASSERT_EQ(std::size_t(5), n->vertices()->size());
    ASSERT_EQ(std::size_t(20), n->edges()->size());
}
...
TEST(net_creation_test, complete_bipartite_graph)
{
    ...
    ASSERT_EQ(std::size_t(7), n->vertices()->size());
    ASSERT_EQ(std::size_t(12), n->edges()->size());
}
...
TEST(net_creation_test, complete_bipartite_graph_directed)
{
    ...
    ASSERT_EQ(std::size_t(7), n->vertices()->size());
    ASSERT_EQ(std::size_t(24), n->edges()->size());
}
...
TEST(net_creation_test, path_graph_directed)
{
    ...
    ASSERT_EQ(std::size_t(3), n->vertices()->size());
    ASSERT_EQ(std::size_t(2), n->edges()->size());
}
...
TEST(net_creation_test, cycle_graph_directed)
{
    ...
    ASSERT_EQ(std::size_t(3), n->vertices()->size());
    ASSERT_EQ(std::size_t(3), n->edges()->size());
}
...
TEST(net_creation_test, wheel_graph)
{
    ...
    ASSERT_EQ(std::size_t(5), n->vertices()->size());
    ASSERT_EQ(std::size_t(8), n->edges()->size());
}
