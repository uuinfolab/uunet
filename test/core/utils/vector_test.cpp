...
{
    std::vector<std::size_t> vec1 = {2,3,4};
    auto res = uu::core::seq(2,4);
    EXPECT_EQ(vec1, res);

    std::vector<std::size_t> vec2 = {4,3,2};
...
TEST(core_utils_test, vector_move)
{
    ...
    std::vector<std::size_t> vec1 = {1,3,4,5,2};
    std::vector<std::size_t> vec2 = {5,1,3,4,2};
    std::vector<std::size_t> vec3 = {1,3,5,4,2};
