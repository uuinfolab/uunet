...
TEST(core_utils_test, math)
{
    ...
    EXPECT_EQ((std::size_t)2, uu::core::s_intersection(sets).size());
    EXPECT_EQ((std::size_t)3, uu::core::s_intersection(hs1, hs2).size());

    EXPECT_EQ((std::size_t)8, uu::core::s_union(sets).size());
    EXPECT_EQ((std::size_t)7, uu::core::s_union(hs1, hs2).size());
