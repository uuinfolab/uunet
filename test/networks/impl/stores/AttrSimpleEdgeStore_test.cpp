 ...
 */
class net_datastructures_stores_AttrSimpleEdgeStore_test : public ::testing::Test
{
  protected:
...
TEST_F(net_datastructures_stores_AttrSimpleEdgeStore_test, access_attributes)
{

    auto store = std::make_unique<uu::net::AttrSimpleEdgeStore>(uu::net::EdgeDir::DIRECTED);
