...
TEST_F(net_algorithms_test, sssp)
{
    ...
    std::size_t pos_v1 = g->vertices()->index_of(v1);
    std::size_t pos_v2 = g->vertices()->index_of(v2);
    std::size_t pos_v3 = g->vertices()->index_of(v3);
    std::size_t pos_v4 = g->vertices()->index_of(v4);
    std::size_t pos_v7 = g->vertices()->index_of(v7);
    std::size_t pos_v8 = g->vertices()->index_of(v8);
